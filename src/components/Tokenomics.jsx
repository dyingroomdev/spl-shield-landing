...
const Tokenomics = () => {
  ...
  const presaleDetails = [
    { label: 'Presale Price', value: '$0.01', icon: DollarSign, highlight: true },
    { label: 'Listing Price', value: '$0.015', icon: TrendingUp, highlight: false },
    { label: 'Raise Target', value: '$250,000', icon: Target, highlight: false },
    { label: 'Total Supply', value: '100,000,000', icon: Coins, highlight: false }
  ];
                ...
                >
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-sm text-gray-500 dark:text-gray-400">
                      {(item.percentage * 1000000).toLocaleString()} TDL
                    </div>
                  </div>
                </div>
              ))}
          ...
          <div className="space-y-6">
            <div className="card p-8 relative overflow-hidden">
              ...
              <div className="relative">
                ...
                {/* CTA Button */}
                <button className="btn-tdl w-full flex items-center justify-center space-x-2 text-lg">
                ...
                <div className="text-center mt-4">
                  <span className="text-sm text-gray-500 dark:text-gray-400">
                    Presale starts Q4 2025 • Limited supply available
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="card p-4 text-center">
                ...
                <div className="font-semibold text-gray-900 dark:text-white text-sm">Burn Mechanism</div>
                <div className="text-xs text-gray-600 dark:text-gray-400">Deflationary</div>
              </div>
            </div>
          </div>
        </div>
